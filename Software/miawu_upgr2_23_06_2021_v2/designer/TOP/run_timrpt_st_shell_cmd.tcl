read_sdc -scenario "timing_analysis" -netlist "user" -pin_separator "/" -ignore_errors {F:/SYSTEMS AIDS_18Feb2019/miawu_v16_21march19/designer/TOP/timing_analysis.sdc}
...
set max_slow_lv_ht [report \
    ...
    -analysis max \
    -format   xml \
    {F:\SYSTEMS AIDS_18Feb2019\miawu_v16_21march19\designer\TOP\TOP_max_timing_slow_1.14V_100C.xml} ]
set min_fast_hv_lt [report \
    -type     timing \
    -analysis min \
    -format   xml \
    {F:\SYSTEMS AIDS_18Feb2019\miawu_v16_21march19\designer\TOP\TOP_min_timing_fast_1.26V_-40C.xml} ]
set max_viol_slow_lv_ht [report \
    -type     timing_violations \
    -analysis max \
    -format   xml \
    {F:\SYSTEMS AIDS_18Feb2019\miawu_v16_21march19\designer\TOP\TOP_max_timing_violations_slow_1.14V_100C.xml} ]
set min_viol_fast_hv_lt [report \
    -type     timing_violations \
    -analysis min \
    -format   xml \
    {F:\SYSTEMS AIDS_18Feb2019\miawu_v16_21march19\designer\TOP\TOP_min_timing_violations_fast_1.26V_-40C.xml} ]
set coverage [report \
    -type     constraints_coverage \
    -format   xml \
    -slacks   no \
    {F:\SYSTEMS AIDS_18Feb2019\miawu_v16_21march19\designer\TOP\TOP_timing_constraints_coverage.xml} ]
report \
    -type     combinational_loops \
    -format   xml \
    {F:\SYSTEMS AIDS_18Feb2019\miawu_v16_21march19\designer\TOP\TOP_timing_combinational_loops.xml}
set_options -max_opcond best
set_options -min_opcond worst
set has_violations {F:\SYSTEMS AIDS_18Feb2019\miawu_v16_21march19\designer\TOP\TOP_has_violations}
